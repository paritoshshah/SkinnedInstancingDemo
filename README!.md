...
1. Once this template project opens, select your `SkinnedInstancingDemo` project in the 
   Xcode *Project Navigator* panel.

2. Select the `SkinnedInstancingDemo` target.

3. Select the *Build Phases* tab of the `SkinnedInstancingDemo` target.
...
`SkinnedInstancingDemoScene.m` file. To add your own 3D content, edit that method.

The `SkinnedInstancingDemoScene.m` file is also where you add interactive behaviour,
